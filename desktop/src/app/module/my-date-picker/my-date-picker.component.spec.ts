...
describe('MyDatePicker', () => {
  ...
  it('options - highlight dates', () => {
    ...
    comp.options = {
      sunHighlight: false,
      satHighlight: false,
      highlightDates: [{year: 2016, month: 1, day: 10}, {year: 2016, month: 1, day: 12}, {
        year: 2016,
        month: 1,
        day: 13
      }]
  ...
  it('options - enable disabled days one by one', () => {
    ...
    comp.options = {
      ...
      enableDays: [{year: 2017, month: 1, day: 5}, {year: 2017, month: 1, day: 6}, {
        year: 2017,
        month: 1,
        day: 7
      }, {year: 2017, month: 1, day: 8}]
    };
  ...
  it('options - mark dates', () => {
    ...
    comp.options = {
      markDates: [{
        dates: [{year: 2017, month: 1, day: 14}, {year: 2017, month: 1, day: 15}],
        color: 'red'
      }]
    };
