/*1495030900,,JIT Construction: v3026736,en_US*/
...
try {
  window.FB || (function (window, fb_fif_window) {
    ...
    (function () {
      ...
      with (this) {
        ...
        __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "3026736"});
        __d("JSSDKConfig", [], {
          "bustCache": true,
        ...
        __d("JSSDKXDConfig", [], {
          ...
          "XdBundleUrl": "\/connect\/xd_arbiter\/r\/JtmcTFxyLye.js?version=42",
  ...
  new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"3026736","namespace":"FB","message":"' + e.message + '"}}');
}
