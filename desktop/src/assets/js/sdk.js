try {
  window.FB || (function (window, fb_fif_window) {
    ...
    (function () {
      ...
      with (this) {
          ...
          var h = {
            from: function i(j) {
              ...
              var k = arguments[1], l = arguments[2], m = this, n = Object(j),
                ...
                p = typeof k === 'function', q = typeof n[o] === 'function', r = 0, s = void 0, t = void 0;
              if (q) {
          ...
          var h = {
            find: function i(j, k) {
              ...
              var k = Object(this), l = k.length >>> 0, m = arguments[1], n = m >> 0,
                o = n < 0 ? Math.max(l + n, 0) : Math.min(n, l), p = arguments[2], q = p === undefined ? l : p >> 0,
        ...
        __d('ES7ArrayPrototype', [], (function a(b, c, d, e, f, g) {
          var h = Array.prototype.indexOf;

          function i(m) {
            return Math.min(Math.max(j(m), 0), Number.MAX_SAFE_INTEGER);
          }

          function j(m) {
            var n = Number(m);
            return Number.isFinite(n) && n !== 0 ? k(n) * Math.floor(Math.abs(n)) : n;
          }
          ...
          var l = {
            includes: function m(n) {
              'use strict';
              if (n !== undefined && Array.isArray(this) && !Number.isNaN(n))return h.apply(this, arguments) !== -1;
              var o = Object(this), p = o.length ? i(o.length) : 0;
              if (p === 0)return false;
              var q = arguments.length > 1 ? j(arguments[1]) : 0, r = q < 0 ? Math.max(p + q, 0) : q,
                s = Number.isNaN(n);
              while (r < p) {
                var t = o[r];
                if (t === n || s && Number.isNaN(t))return true;
                r++;
              }
              return false;
            }
         ...
         */__d("JSON3", [], (function a(b, c, d, e, f, g) {
          (function () {
            var h = {}.toString, i, j, k, l = f.exports = {}, m = '{"A":[1,true,false,null,"\\u0000\\b\\n\\f\\r\\t"]}',
              n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca = new Date(-3509827334573292), da, ea, fa;
            try {
        ...
        __d('ES', ['ES5ArrayPrototype', 'ES5FunctionPrototype', 'ES5StringPrototype', 'ES5Array', 'ES5Object', 'ES5Date', 'JSON3', 'ES6Array', 'ES6Object', 'ES6ArrayPrototype', 'ES6DatePrototype', 'ES6Number', 'ES7StringPrototype', 'ES7Object', 'ES7ArrayPrototype'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
          var w = {}.toString, x = {'JSON.stringify': n.stringify, 'JSON.parse': n.parse},
            y = {'Array.prototype': h, 'Function.prototype': i, 'String.prototype': j, Object: l, Array: k, Date: m},
          ...
          function ba(da) {
            for (var ea in da) {
              ...
              var fa = da[ea], ga = ea.split('.');
              if (ga.length === 2) {
                var ha = ga[0], ia = ga[1];
                if (!ha || !ia || !window[ha] || !window[ha][ia]) {
                  var ja = ha ? window[ha] : '-', ka = ha && window[ha] && ia ? window[ha][ia] : '-';
          ...
          function ca(da, ea, fa) {
            var ga = fa ? w.call(da).slice(8, -1) + '.prototype' : da, ha = x[ga + '.' + ea] || da[ea];
            if (typeof ha === 'function') {
              for (var ia = arguments.length, ja = Array(ia > 3 ? ia - 3 : 0),
                     ka = 3; ka < ia; ka++)ja[ka - 3] = arguments[ka];
          ...
          var c = 'keys', d = 'values', e = 'entries', f = function () {
            ...
            if (!l) m = function () {
              ...
              n.prototype.next = function () {
                ...
                var o = this.$ArrayIterator1, p = this.$ArrayIterator1.length, q = this.$ArrayIterator3,
        ...
        __d("JSSDKRuntimeConfig", [], {"locale": "en_US", "rtl": false, "revision": "2976159"});
        __d("JSSDKConfig", [], {
          "bustCache": true,
        ...
        __d("JSSDKXDConfig", [], {
          ...
          "XdBundleUrl": "\/connect\/xd_arbiter\/r\/96nq-xsaNcg.js?version=42",
        ...
        __d('URISchemes', ['createObjectFrom'], (function a(b, c, d, e, f, g, h) {
          var i = h(['blob', 'cmms', 'fb', 'fbatwork', 'fb-ama', 'fb-messenger', 'fb-page-messages', 'fb-pma', 'fbcf', 'fbconnect', 'fbmobilehome', 'fbrpc', 'file', 'ftp', 'http', 'https', 'mailto', 'ms-app', 'intent', 'itms', 'itms-apps', 'itms-services', 'market', 'svn+ssh', 'fbstaging', 'tel', 'sms', 'pebblejs', 'sftp', 'whatsapp', 'moments', 'fblite', 'chrome-extension', 'webcal', 'fb124024574287414', 'fb124024574287414rc', 'fb124024574287414master', 'fb1576585912599779', 'fb929757330408142', 'designpack', 'fbapi20130214', 'fb1196383223757595']),
            j = {
        ...
        __d('sdk.RPC', ['Assert', 'JSONRPC', 'Queue'], (function a(b, c, d, e, f, g, h, i, j) {
          var k = new j(), l = new i(function (n) {
            ...
            local: l.local, remote: l.remote, stub: ES(l.stub, 'bind', true, l), setInQueue: function n(o) {
              h.isInstanceOf(j, o);
              o.start(function (p) {
                l.read(p);
              });
        ...
        __d('sdk.XD', ['sdk.Content', 'sdk.Event', 'Log', 'QueryString', 'Queue', 'sdk.RPC', 'sdk.Runtime', 'sdk.Scribe', 'sdk.URI', 'UrlMap', 'JSSDKXDConfig', 'XDM', 'isFacebookURI', 'sdk.createIframe', 'sdk.feature', 'guid'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w) {
          var x = new l(), y = new l(), z = new l(), aa, ba, ca = w(), da = r.useCdn ? 'cdn' : 'www',
            ea = v('use_bundle', false) ? r.XdBundleUrl : r.XdUrl, fa = q.resolve(da, false) + ea,
            ga = q.resolve(da, true) + ea, ha = function va() {
            ...
            }, ia = w(), ja = ha(), ka, la = false, ma = 'Facebook Cross Domain Communication Frame', na = {},
            oa = new l();
          m.setInQueue(oa);
          function pa(va) {
        ...
        __d('sdk.Auth', ['sdk.Cookie', 'sdk.createIframe', 'DOMWrapper', 'sdk.feature', 'sdk.getContextType', 'guid', 'sdk.Impressions', 'Log', 'ObservableMixin', 'sdk.Runtime', 'sdk.Scribe', 'sdk.SignedRequest', 'UrlMap', 'sdk.URI', 'sdk.XD'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
          ...
          function ba(ja, ka) {
            ...
            var oa = q.getLoginStatus(), pa = oa === 'unknown' && ja || q.getUseCookie() && q.getCookieUserID() !== ma,
              qa = la && !ja, ra = ja && la && la != ma, sa = ja != y, ta = ka != (oa || 'unknown');
            q.setLoginStatus(ka);
            ...
            switch (ha) {
              ...
              default:
                return m.guard(function () {
                  ...
                  var ja = ES(Array.prototype.slice.call(arguments), 'map', true, ia), ka = da.apply(ga, ja), la,
                    ma = true;
        ...
        __d('ApiClient', ['ArgumentError', 'Assert', 'CORSRequest', 'FlashRequest', 'flattenObject', 'JSONPRequest', 'Log', 'ObservableMixin', 'QueryString', 'sprintf', 'sdk.URI', 'UrlMap', 'ApiClientConfig', 'invariant', 'sdk.safelyParseResponse'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v) {
          var w, x, y, z = m.MAX_QUERYSTRING_LENGTH, aa = {get: true, post: true, 'delete': true, put: true}, ba = {
              fql_query: true,
              fql_multiquery: true,
              friends_get: true,
              ...
              stream_get: true,
              users_getinfo: true
            }, ca = ['jsonp', 'cors', 'flash'], da = [], ea = [], fa = null, ga = 0, ha = [], ia = 0, ja = 50,
            ka = 105440539523;
          ...
          function pa(va) {
            var wa = na(va), xa = wa.uri, ya = wa.callback, za = wa.params.method, ab,
          ...
          function qa() {
            for (var va = arguments.length, wa = Array(va), xa = 0; xa < va; xa++)wa[xa] = arguments[xa];
            var ya = pa(wa), za = ya.body, ab = ya.callback, bb = ya.method, cb = ya.relative_url,
          ...
          function sa(va, wa) {
            ...
            va.api_key = x;
            var ya = xa in ba ? 'api_read' : 'api', za = s.resolve(ya) + '/restserver.php',
        ...
        __d('FBEventsUtils', [], (function a(b, c, d, e, f, g) {
          'use strict';
          var h = 'console', i = 'error', j = 'Facebook Pixel Error', k = 'Facebook Pixel Warning', l = 'warn',
            m = Object.prototype.toString, n = !('addEventListener' in document), o = function w() {
          ...
          function u(w, x, y) {
            x = n ? 'on' + x : x;
            var z = n ? 'attachEvent' : 'addEventListener', aa = n ? 'detachEvent' : 'removeEventListener',
              ba = function ca() {
                w[aa](x, ca, false);
                y();
              };
        ...
        __d('FBPixelEndpoint', ['FBEventsParamList', 'FBEventsUtils'], (function a(b, c, d, e, f, g, h, i) {
          'use strict';
          var j = 'https://www.facebook.com/tr/', k = location.href, l = window.top !== window, m = document.referrer;
          ...
          function q(s, t) {
            ...
            var w = !!(window.attachEvent && !window.addEventListener), x = w ? '<iframe name="' + u + '">' : 'iframe',
        ...
        __d('FBAppEvents', ['FBPixelEndpoint'], (function a(b, c, d, e, f, g, h) {
          ...
          f.exports = {logEvent: i};
        }), null);
        __d('sdk.AppEvents', ['Assert', 'ApiClient', 'sdk.Event', 'sdk.Impressions', 'sdk.Model', 'sdk.Runtime', 'FBAppEvents', 'sdk.Auth'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
          var p = {
            ...
            }, q = {ACTIVATED_APP: 'fb_mobile_activate_app', PURCHASED: 'fb_mobile_purchase'}, r = {
            ...
            }, s = /^[0-9a-zA-Z_][0-9a-zA-Z _-]{0,39}$/, t = s, u = 40, v = 100, w = 100, x = 40, y = 100,
            z = new l({UserID: ''});

          function aa(na, oa, pa, qa) {
            var ra = {ae: 1, ev: oa, vts: pa, canvas: 1};
            if (qa) ra.cd = qa;
            k.impression({api_key: na, payload: ES('JSON', 'stringify', false, ra)});
          }

          function ba(na, oa, pa, qa) {
            var ra = o.getAuthResponse(), sa = ra && ra.accessToken ? ra.accessToken : null;
            n.logEvent(na, oa, qa || {}, pa, sa);
          }

          function ca(na, oa, pa, qa) {
            da(oa);
          ...
          function da(na) {
            h.isTrue(s.test(na), 'Invalid event name: ' + na + '. ' + 'It must be between 1 and ' + u + ' characters, ' + 'and must be contain only alphanumerics, _, - or spaces, ' + 'starting with alphanumeric or _.');
          }

          function ea(na, oa, pa, qa) {
            var ra = {};
            ra[r.CURRENCY] = pa;
            ca(na, q.PURCHASED, oa, babelHelpers['extends']({}, qa, ra));
          }

          function fa(na) {
            ca(na, q.ACTIVATED_APP);
          }
          ...
          function ha(na) {
            h.isTrue(na.length > 0 && na.length <= v, 'Invalid user ID: ' + na + '. ' + 'It must be no longer than ' + v + ' characters.');
          }
          ...
          function la(na) {
            h.isTrue(ES('Object', 'keys', false, na).length <= w, 'The total number of user properties cannot exceed ' + w + '.');
            for (var oa in na) {
              h.isTrue(t.test(oa), 'Invalid user properties key name: ' + oa + '. ' + 'It must be between 1 and ' + x + ' ' + 'characters, and must be contain only alphanumerics, _, - or spaces, ' + 'starting with alphanumeric or _.');
              h.isTrue(na[oa].toString().length <= y, 'Invalid user properties value: ' + na[oa] + '. ' + 'It must be no longer than ' + y + ' characters.');
            }
          }
          ...
          function ma(na, oa, pa) {
            ...
            ha(qa);
            la(oa);
            var ra = '/' + na + '/user_properties', sa = {data: [{user_unique_id: qa, custom_data: oa}]};
            i.graph(ra, 'post', sa, pa);
          }

          j.subscribe('init:post', function (na) {
            if (m.getClientID()) {
              if (na.autoLogAppEvents !== undefined) {
                h.isBoolean(na.autoLogAppEvents, 'Type of property autoLogAppEvents must be boolean');
                m.setAutoLogAppEvents(na.autoLogAppEvents);
              }
              if (m.getAutoLogAppEvents()) ga(m.getClientID());
            }
          });
          f.exports = {
            activateApp: fa,
            ...
            logPurchase: ea,
            logPageView: ga,
            assertValidEventName: da,
            EventNames: p,
            ParameterNames: r,
            assertValidUserID: ha,
            setUserID: ia,
            getUserID: ja,
            clearUserID: ka,
            assertValidUserProperties: la,
            updateUserProperties: ma
          };
        }), null);
        ...
        __d('sdk.openMessenger', ['sdk.UA'], (function a(b, c, d, e, f, g, h) {
          ...
          var i = 'https://itunes.apple.com/us/app/messenger/id454638411',
            j = 'https://play.google.com/store/apps/details?id=com.facebook.orca', k = 3000;
        ...
        __d('sdk.UIServer', ['sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Dialog', 'sdk.Event', 'sdk.Frictionless', 'Log', 'sdk.Native', 'QueryString', 'sdk.RPC', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap', 'sdk.XD', 'createObjectFrom', 'sdk.feature', 'sdk.fbt', 'flattenObject', 'sdk.getContextType', 'guid', 'insertIframe', 'sdk.openMessenger', 'resolveURI'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, aa, ba, ca, da, ea) {
          var fa = {
            ...
            'stream.share': {
              size: {width: 670, height: 340}, url: 'sharer.php', transform: function la(ma) {
          ...
          var ka = {
            ...
            prepareCall: function la(ma, na) {
              var oa = ma.method.toLowerCase(),
                ...
                qa = ba(), ra = r.getSecure() || oa !== 'auth.status' && oa != 'login.status';
            ...
            popup: function la(ma) {
              var na = typeof window.screenX != 'undefined' ? window.screenX : window.screenLeft,
                ...
                ra = t.mobile() ? null : ma.size.width, sa = t.mobile() ? null : ma.size.height,
                ta = na < 0 ? window.screen.width + na : na, ua = parseInt(ta + (pa - ra) / 2, 10),
                va = parseInt(oa + (qa - sa) / 2.5, 10), wa = [];
        ...
        __d('sdk.Canvas.IframeHandling', ['DOMWrapper', 'sdk.RPC'], (function a(b, c, d, e, f, g, h, i) {
          ...
          function l() {
            var p = h.getWindow().document, q = p.body, r = p.documentElement, s = Math.max(q.offsetTop, 0),
              t = Math.max(r.offsetTop, 0), u = q.scrollHeight + s, v = q.offsetHeight + s, w = r.scrollHeight + t,
              x = r.offsetHeight + t;
        ...
        __d('sdk.Canvas.Plugin', ['Log', 'sdk.RPC', 'sdk.Runtime', 'sdk.UA', 'sdk.api'], (function a(b, c, d, e, f, g, h, i, j, k, l) {
          var m = 'CLSID:D27CDB6E-AE6D-11CF-96B8-444553540000', n = 'CLSID:444785F1-DE89-4295-863A-D46C3A781394',
            o = null, p = k.osx() && k.osx.getVersionParts(),
        ...
        __d('IframePlugin', ['sdk.Auth', 'sdk.DOM', 'sdk.Event', 'Log', 'ObservableMixin', 'sdk.PlatformVersioning', 'QueryString', 'sdk.Runtime', 'Type', 'sdk.UA', 'sdk.URI', 'UrlMap', 'sdk.XD', 'sdk.createIframe', 'sdk.feature', 'guid', 'resolveURI'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x) {
          ...
          var ga = p.extend({
            constructor: function ha(ia, ja, ka, la) {
              ...
              var ja = i.getPosition(this._iframe).x, ka = i.getViewportInfo().width,
                la = parseInt(i.getStyle(this._iframe, 'width'), 10), ma = {};
              if (ja + ia > ka && ja > ia) {
        ...
        __d('PluginTags', [], (function a(b, c, d, e, f, g) {
          var h = {
            ...
            messengertoggle: {messenger_app_id: 'string', page_id: 'string', token: 'string', psid: 'string'},
            messengermessageus: {messenger_app_id: 'string', page_id: 'string', color: 'string', size: 'string'},
            send_to_messenger: {
              messenger_app_id: 'string',
              page_id: 'string',
              color: 'string',
        ...
        __d('sdk.XFBML.IframeWidget', ['sdk.Arbiter', 'sdk.Auth', 'sdk.Content', 'sdk.DOM', 'sdk.Event', 'sdk.XFBML.Element', 'guid', 'insertIframe', 'QueryString', 'sdk.Runtime', 'sdk.ui', 'UrlMap', 'sdk.XD'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t) {
          var u = m.extend({
            ...
            _updateIframeZIndex: function y() {
              var z = this.dom.getElementsByTagName('span')[0], aa = this.getIframeNode(),
            ...
            _repositionIframe: function y(z) {
              var aa = this.getIframeNode(), ba = parseInt(k.getStyle(aa, 'width'), 10), ca = k.getPosition(aa).x,
                da = k.getViewportInfo().width, ea = parseInt(z.width, 10);
              if (ca + ea > da && ca > ea) {
        ...
        __d('sdk.XFBML.Comments', ['sdk.Event', 'sdk.XFBML.IframeWidget', 'QueryString', 'sdk.Runtime', 'JSSDKConfig', 'sdk.UA', 'UrlMap'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n) {
          var o = 320, p = i.extend({
            _visibleAfter: 'immediate', _refreshOnAuthChange: true, setupAndValidate: function q() {
              var r = {
            ...
            constructor: function n(o, p, q, r) {
              ...
              this.subscribe('xd.login_button_dialog_open', function (v) {
                k(ES('JSON', 'parse', false, v.params), function (w) {
                  t(w);
                  l.sendToFacebook(u, {method: 'loginReload', params: ES('JSON', 'stringify', false, w)});
                });
              });
        ...
        __d('sdk.XFBML.Quote', ['sdk.DOM', 'DOMEventListener', 'IframePlugin', 'UnicodeUtils', 'sdk.UA', 'sdk.XD', 'containsNode', 'sdk.feature'], (function a(b, c, d, e, f, g, h, i, j, k, l, m, n, o) {
          ...
          function aa(da) {
            var ea = w && w.offsetWidth, fa = ea ? w.offsetHeight : r, ga = ea ? w.offsetWidth : q,
              ha = da.getRangeAt(0), ia = document.createElement('span'), ja = document.createElement('span'),
  ...
  new Image().src = "https:\/\/www.facebook.com\/" + 'common/scribe_endpoint.php?c=jssdk_error&m=' + encodeURIComponent('{"error":"LOAD", "extra": {"name":"' + e.name + '","line":"' + (e.lineNumber || e.line) + '","script":"' + (e.fileName || e.sourceURL || e.script) + '","stack":"' + (e.stackTrace || e.stack) + '","revision":"2976159","namespace":"FB","message":"' + e.message + '"}}');
}
